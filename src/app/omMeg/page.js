            ...
            <div className="w-4/6 flex flex-col ">
                    <div className="w-full flex flex-col p-12 gap-7">
                        <div className="flex flex-col gap-3">
                            <h1>Hvem er jeg?</h1>
                            <p className="lg:text-[20px] lg:pb-12 md:pb-7 p-5 md:p-0 text-center md:text-left">En rolig mann fra Bergen som brenner for design, kreativitet og utvikling</p>
                        </div>
                        ...
                        <div className="w-full flex flex-col items-center pt-16 pr-12 gap-12">
                           ...
                           <div className="w-full flex flex-row justify-evenly items-center">
                                <div className="flex flex-col items-center gap-3">
                                    <Image src={Briller}/>
                                    <p className="w-4/6 text-center">Ser hva andre er gode på</p>
                                </div>

                                <div className="flex flex-col items-center gap-3">
                                    <Image src={Books}/>
                                    <p className="w-4/6 text-center">Liker å lære nye ting</p>
                                </div>

                                <div className="flex flex-col items-center gap-3">
                                    <Image src={Lys}/>
                                    <p className="w-4/6 text-center">Kreativ og løsningsorientert</p>
                                </div>

                                <div className="flex flex-col items-center gap-3">
                                    <Image src={Target}/>
                                    <p className="w-4/6 text-center">Målrettet, liker å se resultater</p>
                                </div>
                           </div>
                        </div>
                    </div>
